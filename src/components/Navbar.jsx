            ...
            <nav className='bg-gray-700 py-3'>
                <div className='container  flex justify-between items-center mt-1 mb-1 '>
                    ...
                    <ul className="flex justify-center items-center space-x-10">
                        ...
                        <li>
                            <Link to="/Inventory" className='hover:underline hover:text-green-500 text-white transition duration-300 ease-in-out font-bold '>Inventory</Link>
                        </li><li>
                            <Link to="/Sale" className='hover:underline hover:text-green-500 text-white transition duration-300 ease-in-out font-bold '>Sales</Link>
                        </li>
                    </ul>
                    <div>
